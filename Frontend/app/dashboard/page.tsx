                ...
                {filteredTools.length === 0 ? (
                  ...
                  filteredTools.map((tool) => (
                    <tr key={tool._id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium ${statusConfig[tool.status as keyof typeof statusConfig]?.color || 'text-gray-700 bg-gray-100'}`}>
